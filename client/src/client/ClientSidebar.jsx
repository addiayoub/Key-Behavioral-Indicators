...
const ClientSidebar = ({ activeTab, setActiveTab, sidebarOpen, setSidebarOpen, clientData, handleLogout }) => {
  const sidebarItems = [
      ...
      <div className="p-6">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            {clientData.logo ? (
              <img src={clientData.logo} alt="Logo" className="w-10 h-10 rounded-lg" />
            ) : (
